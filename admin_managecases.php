    ...
    <div class="main-content">
        ...
        <div class="content">
            <div class="action-bar">
                ...
                <div class="filters">
                    <button class="filter-btn active" data-status="">All Status</button>
    ...
    <script>
        ...
        function filterCases() {
            ...
            rows.forEach(row => {
                ...
                if (!shouldShow) {
                    console.log('Hiding row:', row.querySelector('.case-id')?.textContent, 'Type:', type, 'Status:', status);
                } else {
                    console.log('Showing row:', row.querySelector('.case-id')?.textContent, 'Type:', type, 'Status:', status);
                }
            });
        }
    </script>
