...
try {
    ...
    if ($_SESSION['user_type'] === 'admin') {
        ...
        // Employees can update events they created or events with no specific attorney restriction
        $where_clause .= " AND (created_by_employee_id = ? OR created_by_employee_id IS NOT NULL)";
        $params[] = $_SESSION['user_id'];
        $types .= "i";
