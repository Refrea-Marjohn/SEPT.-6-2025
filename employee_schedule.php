                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventDidMount: function(info) {
                        ...
                        if (info.event.extendedProps.attorneyName) {
                            ...
                            const attorneyUserType = info.event.extendedProps.attorneyUserType;
                            let backgroundColor = '#6c757d'; // Default gray
                            let borderColor = '#6c757d';
                            
                            console.log('Event:', info.event.title, 'Attorney:', attorneyName, 'Type:', attorneyUserType);
                            
                            // Set colors based on attorney name
                            if (attorneyUserType === 'admin') {
                                backgroundColor = '#ff6b6b'; // Light Red for Admin
                                borderColor = '#ff5252';
                                console.log('Applying ADMIN colors:', backgroundColor);
                            } else {
